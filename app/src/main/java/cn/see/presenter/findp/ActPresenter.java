...
public class ActPresenter extends XPresent<FindActFragment> {
    ...
    public void getTextAct(String user_id, final int page){
        ...
        Api.findService().getFindAct(user_id,page,"15")
    ...
    public CommonListViewAdapter<FindActModel.ActResult.ActList> initAdapter(List<FindActModel.ActResult.ActList> actListList){
        ...
        CommonListViewAdapter<FindActModel.ActResult.ActList> adapter = new CommonListViewAdapter<FindActModel.ActResult.ActList>(getV().getActivity(),actListList, R.layout.layout_find_act_item) {
