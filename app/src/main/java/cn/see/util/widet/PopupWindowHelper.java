...
public class PopupWindowHelper {
    ...
    public void showAsDropDown(View anchor, int xoff, int yoff,int type) {
    ...
    public void showFromTop(View anchor,int yoff) {
        initPopupWindow(TYPE_MATCH_PARENT);
        mPopupWindow.setAnimationStyle(R.style.AnimationFromTop);
        mPopupWindow.showAtLocation(anchor, Gravity.LEFT | Gravity.TOP, 0, yoff);
    }
