    ...
    public void onEvent(NotificationClickEvent notificationClickEvent) {
        ...
        if (msg != null) {
            ...
            if (type == ConversationType.single) {
                ...
                notificationIntent.putExtra(App.TARGET_ID, targetId);
                notificationIntent.putExtra(App.TARGET_APP_KEY, appKey);
            } else {
                conv = JMessageClient.getGroupConversation(Long.parseLong(targetId));
                notificationIntent.putExtra(App.GROUP_ID, Long.parseLong(targetId));
            }
            notificationIntent.putExtra(App.CONV_TITLE, conv.getTitle());
