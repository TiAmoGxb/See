...
import cn.see.chat.adapter.ConversationListAdapter;
...
public class ConversationListController implements View.OnClickListener,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (position > 0) {
            ...
            intent.putExtra(App.CONV_TITLE, conv.getTitle());
            //群聊
            if (conv.getType() == ConversationType.group) {
                ...
                intent.putExtra(App.TARGET_APP_KEY, conv.getTargetAppKey());
                intent.putExtra(App.DRAFT, getAdapter().getDraft(conv.getId()));
            }
            intent.setClass(mContext.getActivity(), ChatActivity.class);
