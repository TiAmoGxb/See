package cn.see.chat.location.activity;
...
import cn.see.chat.location.adapter.MapPickerAdapter;
import cn.see.chat.location.service.LocationService;
...
//        locationService = App.locationService;
        ...
        String targetId = getIntent().getStringExtra(App.TARGET_ID);
        String targetAppKey = getIntent().getStringExtra(App.TARGET_APP_KEY);
                ...
                mBaiduMap.snapshotScope(rect, new BaiduMap.SnapshotReadyCallback() {
                    ...
                    public void onSnapshotReady(Bitmap bitmap) {
                        if (null != bitmap && null != conv) {
                            ...
                            setResult(App.RESULT_CODE_SEND_LOCATION, intent);
                            finish();
                        } else {
                            Toast.makeText(App.getContext(), getString(R.string.send_location_error),
