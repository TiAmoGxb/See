...
import cn.see.chat.controller.ChatDetailController;
...
public class ChatDetailActivity extends BaseActivity {
    ...
    public void onBackPressed() {
        ...
        intent.putExtra(App.CONV_TITLE, mChatDetailController.getName());
        intent.putExtra(App.MEMBERS_COUNT, mChatDetailController.getCurrentCount());
        intent.putExtra("deleteMsg", mChatDetailController.getDeleteFlag());
        setResult(App.RESULT_CODE_CHAT_DETAIL, intent);
        finish();
        super.onBackPressed();
    }
            ...
            switch (requestCode) {
                ...
                case MY_NAME_REQUEST_CODE:
                    if (data.getBooleanExtra("returnChatActivity", false)) {
                        ...
                        data.putExtra(App.NAME, mChatDetailController.getName());
                        setResult(App.RESULT_CODE_CHAT_DETAIL, data);
                        finish();
                    }
                    break;
                case App.REQUEST_CODE_ALL_MEMBER:
    ...
    public void startChatActivity(long groupID, String groupName, int member) {
        ...
        intent.putExtra(App.MEMBERS_COUNT, member + 1);
        intent.putExtra(App.GROUP_ID, groupID);
        intent.putExtra(App.CONV_TITLE, groupName);
    ...
    public void onEvent(MessageEvent event) {
        ...
        if (msg.getContentType() == ContentType.eventNotification) {
            ...
            handleMsg.what = App.ON_GROUP_EVENT;
            Bundle bundle = new Bundle();
            bundle.putLong(App.GROUP_ID, ((GroupInfo) msg.getTargetInfo()).getGroupID());
