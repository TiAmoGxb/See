...
import cn.see.chat.adapter.AllMembersAdapter;
...
import cn.see.chat.utils.pinyin.HanyuPinyin;
...
//        mSideBar.setTextView(mLetterHintTv);
        ...
        mIsDeleteMode = getIntent().getBooleanExtra(App.DELETE_MODE, false);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.return_btn:
                    ...
                    setResult(App.RESULT_CODE_ALL_MEMBER, intent);
                    finish();
                    break;
                case R.id.right_btn:
                    if (mIsDeleteMode) {
