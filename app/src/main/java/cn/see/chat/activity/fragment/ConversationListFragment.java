...
import cn.see.chat.controller.ConversationListController;
import cn.see.chat.controller.MenuItemController;
import cn.see.chat.entity.Event;
import cn.see.chat.view.ConversationListView;
import cn.see.chat.view.MenuItemView;
    ...
    public void onEvent(MessageEvent event) {
        ...
        if (msg.getTargetType() == ConversationType.group) {
            ...
            if (conv != null && mConvListController != null) {
                if (msg.isAtMe()) {
                    App.isAtMe.put(groupId, true);
                    mConvListController.getAdapter().putAtConv(conv, msg.getId());
                }
                if (msg.isAtAll()) {
                    App.isAtall.put(groupId, true);
