package cn.see.chat.activity.historyfile.controller;
...
import cn.see.chat.activity.historyfile.fragment.AudioFileFragment;
import cn.see.chat.activity.historyfile.fragment.DocumentFileFragment;
import cn.see.chat.activity.historyfile.fragment.ImageFileFragment;
import cn.see.chat.activity.historyfile.fragment.OtherFileFragment;
import cn.see.chat.activity.historyfile.fragment.VideoFileFragment;
import cn.see.chat.activity.historyfile.view.HistoryFileView;
import cn.see.chat.adapter.ViewPagerAdapter;
import cn.see.chat.entity.SelectedHistoryFileListener;
        ...
        switch (view.getId()) {
            ...
            case R.id.delete_file_btn:
                ...
                for (Integer id : idMap.keySet()) {
                    ...
                    App.ids.add(conversation.getMessage(idMap.get(id)));
